...
class Queue<T>
{
    ...
    /// <summary>
    /// Prints values of the queue starting with head.  "Queue is empty" if queue is empty.
    /// </summary>
    public void Print()
    {
        if (head == null)
    ...
    /// <summary>
    /// Concatenates all the values of the queue.
    /// </summary>
    /// <returns>Concatenated string if type is string; otherwise null</returns>
    public string Concatenate()
    {
        ...
        if (typeof(T).Name is string)
        {
            ...
            while (tempN != null)
            {
                if (first != true && typeof(T).Name == "String")
                    tempS += " ";
                tempS += tempN.value;
                tempN = tempN.next;
                first = false;
